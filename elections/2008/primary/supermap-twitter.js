		...
		opt.projector ? [
			...
			'<div id="outer">',
				...
				'<div style="padding-bottom:4px; border-bottom:1px solid #DDD; margin-bottom:4px;">',
					...
					'<a href="http://gmodules.com/ig/creator?synd=open&url=http://googlemaps.github.io/js-v2-samples/elections/2008/primary/supermap2.xml" target="_blank">Get this map for your website</a>',
				'</div>',
				//twitterBlurb,
				//'<div style="padding-bottom:4px; border-bottom:1px solid #DDD; margin-bottom:4px;">',
...
function load() {
	...
	counties && counties.forEach( function( county ) {
		county.shapes.forEach( function( shape ) {
