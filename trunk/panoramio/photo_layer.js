...
PhotoLayerCallback.prototype.createMarker = function(photo, baseIcon) {
  ...
  var marker = new GMarker(this.getLatLng(photo), {icon: markerIcon, title: title});
...
PhotoLayer.prototype.load = function(panoLayer, options) {
  ...
  var url = "http://picasaweb.google.com/data/feed/api/all?kind=photo&tag=ugly&bbox=" + 
...
//  document.documentElement.firstChild.appendChild(script);
  ...
  var url = "http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=a0de4a213ab1191732ec4db4daf586a3&extras=geo,owner_name&tags=ugly&sort=interestingness-desc&per_page=20&bbox=" + options.west + "," + options.south + "," + options.east + "," + options.north + "&format=json&";
